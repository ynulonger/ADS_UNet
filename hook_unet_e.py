...
state_dict = torch.load(f'checkpoints/BCSS/UNet_e/34_0.001_UNet_e_ce.pth', map_location=device)
...
classes = 5
nodes = 4
model =  UNet_e(n_channels=3, n_classes=classes, filters=64, flag='feat').cuda()
...
get_similarity_matrix(svcca, f'UNet_e_out')
